...
const seeds: ScenarioSeed[] = [
  ...
  },
  {
    ...
    cta: { text: ['Review repository settings', 'Repository-Einstellungen prüfen'], url: 'https://github.com/northwind-tools/web-portal/settings/keys' },
  ...
  },
  {
    ...
    cta: { text: ['View completed document', 'Abgeschlossenes Dokument ansehen'], url: 'https://demo.docusign.net/Signing/EmailStart.aspx?m=nda-2941-0058' },
  ...
  },
  {
    ...
    cta: { text: ['Open Jira', 'Jira öffnen'], url: 'https://northwind-tools.atlassian.net/browse/SEC-184' },
  ...
  },
  {
    ...
    cta: { text: ['Review sign-in event', 'Anmeldeereignis prüfen'], url: 'https://accounts.google.com/o/oauth2/v2/auth?continue=https%3A%2F%2Fworkspace-review.net%2Fsession' },
    ...
    clues: [['The link bar shows green — the URL opens on accounts.google.com — but the ?continue= parameter redirects to workspace-review.net, outside Google', 'Die Preview-Bar zeigt Grün — die URL liegt auf accounts.google.com — aber der ?continue=-Parameter leitet weiter zu workspace-review.net, außerhalb von Google'], ['workspace-review.net is not a Google property — scroll the full URL to spot the redirect target', 'workspace-review.net gehört nicht zu Google — die vollständige URL lesen, um das Weiterleitungsziel zu erkennen'], ['Security-event wording creates fast compliance', 'Security-Event-Sprache erzeugt schnellen Gehorsam'], ['Open the admin console directly instead', 'Admin-Konsole direkt öffnen']],
  },
  {
    difficultyLevel: 'advanced',

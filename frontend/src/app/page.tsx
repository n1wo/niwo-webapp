...
const SERVICE_CARDS = [
  ...
  },
  {
    ...
    accent: "Ship with guardrails",
    visual: "workflow",
  },
 ] as const;

function ServiceVisual({ visual }: { visual: (typeof SERVICE_CARDS)[number]["visual"] }): JSX.Element {
  if (visual === "windows") {
    return (
...
export default function Home(): JSX.Element {
  ...
  return (
    <article className="flex flex-col items-center px-6 pt-10 pb-32 text-center font-ibm sm:px-12 md:px-20">
      ...
      <div className="z-20 mt-24 flex w-full max-w-5xl flex-col items-center gap-14 sm:mt-28 sm:gap-16">
              ...
              {SERVICE_CARDS.map((card, index) => (
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col">
                    <p className="mb-2 text-[0.7rem] uppercase tracking-[0.24em] text-zinc-500">
                      {card.eyebrow}
                    </p>
